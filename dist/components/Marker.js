  ...
  var Marker = exports.Marker = function (_React$Component) {
    ...
    _createClass(Marker, [{
      ...
      value: function componentDidUpdate(prevProps) {
        if (this.props.map !== prevProps.map || this.props.position !== prevProps.position || this.props.icon !== prevProps.icon || this.props.animation !== prevProps.animation) {
          if (this.marker) {
      ...
      value: function renderMarker() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['map', 'google', 'position', 'mapCenter', 'icon', 'label', 'draggable', 'title', 'animation', 'zIndex']);
